...
Sentinel社区 从1.5.0版本适配了对 WebFlux的支持，如果想要使用 WebFlux， 需要在项目中引入WebFlux依赖
[source,xml]
----
<dependency>
...
更多信息请参考 Spring Cloud Alibaba社区提供的 https://github.com/alibaba/spring-cloud-alibaba/tree/2021.x/spring-cloud-alibaba-examples/sentinel-example/sentinel-webflux-example[entinel-webflux-example]
