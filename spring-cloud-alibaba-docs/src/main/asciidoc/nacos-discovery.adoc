...
please use the starter with the group ID as `com.alibaba.cloud` and the artifact ID as `alibaba-nacos-discovery-spring-cloud-starter`.
...
alibaba-nacos-discovery-spring-cloud-starter provides an EndPoint, and the address is `http://ip:port/actuator/nacos-discovery`.
...
The following shows the other configurations of the starter of alibaba-nacos-discovery-spring-cloud-starter:
