...
==== Both register IPv4 and IPv6
It is not necessary to configure that IPv4 and IPv6 are registered in the registry by default. IPv4 is in the IP field and IPv6 is in the metadata field.
