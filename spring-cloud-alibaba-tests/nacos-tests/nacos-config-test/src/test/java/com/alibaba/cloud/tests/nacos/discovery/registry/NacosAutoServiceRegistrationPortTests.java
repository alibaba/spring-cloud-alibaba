...
@SpringBootTest(classes = NacosAutoServiceRegistrationPortTests.TestConfig.class, properties = {
		...
		"spring.cloud.nacos.discovery.port=8888" }, webEnvironment = NONE)
public class NacosAutoServiceRegistrationPortTests {
	...
	@Mock
	private NacosAutoServiceRegistrationManagementPortTests.MockManagementServer mockManagementServer;
