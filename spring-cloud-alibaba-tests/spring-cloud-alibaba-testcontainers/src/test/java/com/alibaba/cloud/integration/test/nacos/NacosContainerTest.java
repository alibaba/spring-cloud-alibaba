...
@Slf4j public class NacosContainerTest extends NacosBootTester {
		
		private static final String image = "freemanlau/nacos:1.4.2";
		private NacosContainer nacosContainer;
		
		@Override public void vaildateUpdateState(NacosConfig nacosConfig,
		...
		@Override protected String uploadFile(UserProperties userProperties) {
		...
		@Test public void testNacosStartUp() throws Exception {
