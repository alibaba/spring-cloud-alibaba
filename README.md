...
See the [中文文档](https://github.com/alibaba/spring-cloud-alibaba/blob/2025.0.x/README-zh.md) for Chinese readme.
...
For more features, please refer to [Roadmap](https://github.com/alibaba/spring-cloud-alibaba/blob/2025.0.x/Roadmap.md).
...
[Sentinel Example](https://github.com/alibaba/spring-cloud-alibaba/tree/2025.0.x/spring-cloud-alibaba-examples/sentinel-example/sentinel-core-example/readme.md)

[Nacos Example](https://github.com/alibaba/spring-cloud-alibaba/blob/2025.0.x/spring-cloud-alibaba-examples/nacos-example/readme.md)

[RocketMQ Example](https://github.com/alibaba/spring-cloud-alibaba/blob/2025.0.x/spring-cloud-alibaba-examples/rocketmq-example/readme.md)
