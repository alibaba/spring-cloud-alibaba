...
public class MtlsNettyServerCustomizer implements NettyServerCustomizer {
    ...
    public MtlsNettyServerCustomizer(AbstractCertManager certManager, MtlsSslStoreProvider sslStoreProvider){
    ...
    private SslContextBuilder getContextBuilder() {
        ...
        SslContextBuilder builder = SslContextBuilder.forServer(getKeyManagerFactory(ssl, this.sslStoreProvider))
    ...
    private KeyManagerFactory getKeyManagerFactory(Ssl ssl, MtlsSslStoreProvider sslStoreProvider) {
        try {
            ...
            if(ssl.getKeyAlias() == null){
                ...
                keyManagerFactory = new ConfigurableAliasKeyManagerFactory(ssl.getKeyAlias(),
    ...
    private TrustManagerFactory getTrustManagerFactory(MtlsSslStoreProvider sslStoreProvider) {
        try {
            KeyStore store = null;
            try{
                if (sslStoreProvider != null) {
