...
public interface Timer {
	 ...
	 * already
	 * @throws RejectedExecutionException if the pending timeouts are too many and
	 * creating new timeout can cause instability in the system.
	 */
	Timeout newTimeout(TimerTask task, long delay, TimeUnit unit);

	/**
	 * Releases all resources acquired by this {@link Timer} and cancels all tasks which
	 * were scheduled but not executed yet.
