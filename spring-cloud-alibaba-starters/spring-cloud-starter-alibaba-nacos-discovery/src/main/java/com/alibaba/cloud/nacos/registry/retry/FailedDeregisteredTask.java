...
public class FailedDeregisteredTask extends AbstractRetryTask {

	private static final String NAME = "retry deregister";
	...
	public FailedDeregisteredTask(NacosRegistration registration,
	...
	protected void doRetry(Registration registration, ServiceRegistry registry,
		...
		((NacosServiceRegistry) registry).doDeRegister(registration);
		((NacosServiceRegistry) registry).removeFailedDeregisteredTask(registration);
	}
