...
public class IntrospectiveDubboMetadataService implements DubboMetadataService {
	...
	public String getServiceRestMetadata() {
		if (this.dubboServiceMetadataRepository == null) {
			return null;
		}
		Set<ServiceRestMetadata> serviceRestMetadata = this.dubboServiceMetadataRepository.getServiceRestMetadata();
	...
	public Set<String> getAllServiceKeys() {
		...
		return this.dubboServiceMetadataRepository.getAllServiceKeys();
	}
	...
	public Map<String, String> getAllExportedURLs() {
		...
		Map<String, List<URL>> allExportedUrls = this.dubboServiceMetadataRepository.getAllExportedUrls();
	...
	public String getExportedURLs(String serviceInterface, String group, String version) {
		...
		List<URL> urls = this.dubboServiceMetadataRepository.getExportedURLs(serviceInterface, group, version);
