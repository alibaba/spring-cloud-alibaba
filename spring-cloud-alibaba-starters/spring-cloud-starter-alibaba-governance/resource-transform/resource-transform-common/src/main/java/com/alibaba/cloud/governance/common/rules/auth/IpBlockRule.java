...
public class IpBlockRule {
    ...
    public IpBlockRule(String name, AndRule<CidrRange> sourceIps, AndRule<CidrRange> remoteIps, AndRule<CidrRange> destIps) {
        this(name, sourceIps, remoteIps);
        this.destIps = destIps;
    }

    public IpBlockRule(String name, AndRule<CidrRange> sourceIps, AndRule<CidrRange> remoteIps) {
        this.name = name;
