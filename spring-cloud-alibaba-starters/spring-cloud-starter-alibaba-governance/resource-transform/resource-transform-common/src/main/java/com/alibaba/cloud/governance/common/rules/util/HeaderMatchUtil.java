...
public class HeaderMatchUtil {
    public static boolean matchHeader(HttpHeaders headers, String headerName, HeaderMatcher headerMatcher) {
    ...
    public static StringMatcher headerMatch2StringMatch(HeaderMatcher headerMatcher) {
        ...
        if (headerMatcher.getPresentMatch()) {
            ...
            return builder.setSafeRegex(RegexMatcher.newBuilder().build()).setIgnoreCase(true).build();
        }
