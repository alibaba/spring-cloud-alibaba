...
@SpringBootTest(webEnvironment = DEFINED_PORT, classes = Application.class, properties = {
		...
		"feign.sentinel.rules.default[0].statIntervalMs=10000",
		...
		"feign.sentinel.rules.user[0].statIntervalMs=10000",
		...
		"feign.sentinel.rules.[user#specificFeignMethod(boolean)][0].statIntervalMs=10000",
