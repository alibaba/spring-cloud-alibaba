...
> Spring Cloud Alibaba 适配了 Nacos 3.1.1 版本，在本示例中，使用 Nacos 3.1.1 作为 Seata 的配置中心组件。
...
> **注意：**
> Nacos 3.1.1 开启鉴权，需要配置 `username` 和 `password` 属性，否则登陆失败。更多 Nacos 3.1.1 版本相关配置，参考 `nacos-example`。
